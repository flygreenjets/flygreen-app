        ...
        <View style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                <Pressable onPress={() => {setTab(2)}}>
                    <Text style={StyleSheet.compose(styles.buttonText, (tab === 2 ? styles.selectedButtonText : ""))}>Upcoming</Text>
                </Pressable>
            </View>
            <View style={styles.buttonContainer}>
                <Pressable onPress={() => {setTab(3)}}>
                    <Text style={StyleSheet.compose(styles.buttonText, (tab === 3 ? styles.selectedButtonText : ""))}>Past</Text>
                </Pressable>
            </View>
        </View>
    );
